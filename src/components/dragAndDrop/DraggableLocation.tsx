    ...
    return (
        ...
        >
            <div className="group w-full">
                <div
                    className={`flex items-center justify-center py-2 ${isDragging && !isSidebarCollapsed ? "group-active:bg-blue-500 group-active:text-white" : ""} ${!isDragging && !isSidebarCollapsed ? "group-hover:bg-blue-500/10" : ""}`}
                >
